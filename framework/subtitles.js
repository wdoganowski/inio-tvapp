...
var Subtitles = (function() {
	 ...
	 * @private
	 */
	Factory.prototype.setTime = function(time) {
		this.time = time;
		this.render();
	};
	/**
	 ...
	 */
	Factory.prototype.setTTML = function(xml, timeOffset) {
		var scope = this,
			subs = {}, regions = {}, styles = {}, body, head, region, cellResolution, bodyStyles, isFirstStyle = true,
	 ...
	 */
	Factory.prototype.play = function(format, data) {
		var scope = this;
	 ...
	 * @private
	 */
	Factory.prototype.style2css = function(style) {
		if (style.fontFamily) {
	 ...
	 * @private
	 */
	Factory.prototype.getMaxEndTime = function(arr) {
		var times = [];
		for (var i in arr) {
	 ...
	 * @private
	 */
	Factory.prototype.getStyles = function(css, cssOverride) {
	 ...
	 * @private
	 */
	Factory.prototype.renderRegion = function(regionId) {
