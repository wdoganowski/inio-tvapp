 ...
 * @return {Boolean}
 */
Events.prototype.trigger = function(event_name) {
	var args = Array.prototype.slice.call(arguments, 1),
		scope = this,
		cb, fn, once, ret, stopped = false;
 ...
 */
Events.prototype.on = function(event_name, cb, scope, one) {
 ...
 * @param {Boolean} [one=false] If TRUE, listener will be removed after first call
 */
Events.prototype.one = function(event_name, cb, scope) {
 ...
 * @param {Object} [scope=this] Callback's scope
 */
Events.prototype.off = function(event_name, _cb, _scope) {
	var scope = this,
		cb;
